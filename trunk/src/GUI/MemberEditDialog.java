...
public class MemberEditDialog extends javax.swing.JDialog {
	...
	public MemberEditDialog(java.awt.Frame parent, MemberList memberlist, boolean modal, Member member){
		super(parent, modal);
		this.member = member;
	...
	public void initComponents(){
		...
		clubComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Portalis", "Show-Portalis", "Gæst" }));
		...
		//setup input fields from member object
		nameInputField.setText(member.getName());
		genderInputCombBox.setSelectedItem(member.getGender());
	...
	private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                
		...
		//Validation passed, update member
		MemberDAO customerDAO = new MemberDAO();
		Member memberToUpdate = new Member(nameInputField.getText(), getBirthDate(), (String)genderInputCombBox.getSelectedItem(), Integer.valueOf(phoneInputField.getText()),addressInputField.getText(), (String)clubComboBox.getSelectedItem());
		try {
