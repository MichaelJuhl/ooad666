...
public class TicketBuyDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TitelJLabel.setFont(new java.awt.Font("Tahoma", 0, 14));
        TitelJLabel.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        TitelJLabel.setText("Airbourne");

        ArtistJLabel.setFont(new java.awt.Font("Tahoma", 0, 14));
        ...
        RabatSHOWInputJLabel.setFont(new java.awt.Font("Tahoma", 0, 14));
        ...
        FejlLabel.setForeground(new java.awt.Color(255, 0, 51));
        FejlLabel.setText("Fejl");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(FejlLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 419, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void jButtonkoebActionPerformed(java.awt.event.ActionEvent evt) throws NumberFormatException, DALException {
    	...
    	if (customer.getMemberID() == 0) FejlLabel.setText("Medlem findes ikke!");
    	else{
    		//this.dispose();
    		if((event2.getVisitors()-event2.getTicketsSold()>= (jComboBox1.getSelectedIndex()+1)) && (customer.getMemberID() != 0)){
    			...
    			FejlLabel.setText("Der er ikke nok billetter!");
    	}
